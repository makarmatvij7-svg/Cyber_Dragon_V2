    ...
    function DesyncWallbang:Init()
        ...
        function instance:Setup()
            ...
            GunModuleDS.StartShooting = function(gunObject, ...)
                ...
                -- FIX: Use string.char instead of utf8.char for Lua 5.1 compatibility
                ...
                instance.delayTask = task.delay(DESYNC_CONFIG.PACKET_DELAY, function()
                    instance:StopDesync()
                end)
        ...
        function instance:Shutdown()
            ...
            if self.delayTask then
                -- task.cancel not available in all executors, use pcall
                pcall(function() task.cancel(self.delayTask) end)
            end
